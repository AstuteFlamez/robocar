...
| 2× TB6612FNG driver (Pololu #713) | 2 | $4.95 | Turn the four wheel-speed commands into motor current; **STBY (GP14) must stay HIGH** or autonomy commands silently do nothing. | https://www.pololu.com/product/713 | already bought (Phase 1) |
