...
| **WAGO 221-413** lever-nut splice, 3-conductor | 2 | $8.97 | No-solder rail split: one joins LiPo + → both drivers' VM, the other joins LiPo − → both drivers' GND. ~20 A / 600 V rated — far above the ~5.6 A all-stall load. (A WAGO joins *all* inserted wires — no "in"/"out".) | Home Depot (In-Person) | **buy** |
