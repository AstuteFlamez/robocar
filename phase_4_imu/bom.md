...
| **M2.5 nylon standoff kit** | 1 | $10 | **bought in Phase 1 (not a new buy)** — non-conductive, keeps ferrous mass off the magnetometer; mounts the IMU ≥ 5 cm from motors/LiPo. | https://www.cytron.io/p-nylon-m2p5-pcb-standoff-kit-for-raspberry-pi-200pcs |
| **Dupont jumper wires** (M/F, Adafruit #826) | 1 | $8 | **bought in Phase 1 (not a new buy)** — short 3.3 V signal jumps for UART (4 wires) + I²C (4 wires). Never motor power. | https://www.adafruit.com/product/826 |
...
| STEMMA-QT / Qwiic **5-port** hub (Adafruit #5625) | 1 | $5 | **optional** — keyed, reliable I²C fan-out for INA219 (+ PCA9685 in Ph5), fewer Dupont failures from vibration. (Passive hub — fine here since the addresses differ.) | https://www.adafruit.com/product/5625 |
